---
title: Architecture
description: "How Ovrin is put together: a flat root package with the implementation in internal/, three provider seams, and a client an extraction never mutates."
---
